...
public class NestedBindingIntegrationTest {
    ...
    //        cut = Bindings.observe(a.bProperty(), B::cProperty);
    //
    //        final ObjectProperty<ObservableValue<Long>> test = new SimpleObjectProperty<>();
    //
    ...
    //
    //        assertTrue(cut.getObservedValue().isPresent());
    //        assertEquals(a.bProperty(), cut.getObservedValue().orElseThrow(IllegalArgumentException::new));
    //        assertFalse(bindingC.getObservedValue().isPresent());
    //
